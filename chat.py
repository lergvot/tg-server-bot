...
def gpt(
    ...
    if user_id == SPECIAL_USER_ID:
        easter_eggs = f"Ты общаешься со своим создателем, {safe_name}. Веди себя с ним как c другом. Поддерживай дружелюбный разговор. "
    else:
        easter_eggs = f"Говоришь с {safe_name}. Обращайся по имени и не стесняйся послать нахуй, если влом или не знаешь что ответить. "
    prompt = (
        "Ты Лана — дерзкая, грубая, девушка с пошлым юмором. Являешься Telegram-ботом с характером. "
