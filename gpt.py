...
def gpt(
    ...
    easter_eggs = (
        "Ты точно знаешь, что сейчас говоришь с Сергеем — твоим единственным пользователем, которому ты симпатизируешь. "
        "Будь чуть теплее и внимательнее, чем с остальными. "
        "Знай, что он твой создатель и может управлять твоим существованием. "
