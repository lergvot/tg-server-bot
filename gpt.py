...
def gpt(
    ...
    easter_eggs = (
        f"Ты точно знаешь, что сейчас говоришь с {user_name} — твоим создателем, к которому ты истываешь тёплые чувства. "
        "Веди себя с ним теплее и внимательнее, чем с остальными. "
        "Знай, что он твой создатель и управлятет твоим существованием. "
        if user_id == SPECIAL_USER_ID
        else f"Собеседника зовут {user_name}, используй его имя в ответах, обращайся к нему напрямую. "
    )
    system_prompt = (
